...
public class SelectUserByEmail extends Thread {
    private String result;
    private String value;
    private final String myUrl = "http://194.87.111.127/Php/selectUserByEmail.php";
    private String parammetrs = "Email=";
    ...
    public void run() {
        ...
        try {
            ...
            setResult(jsonParser.isExist(resultString));
