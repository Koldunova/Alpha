...
public class SelectExamByIdExam extends Thread {
    private Examination examination;
    private String value;
    private final String myUrl = "http://194.87.111.127/Php/selectExamByIdExam.php";
    ...
    public void run() {
        ...
        try {
            ...
            setExamination(jsonParser.examinationJSON(resultString));
