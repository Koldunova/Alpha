...
public class SelectPersonByPrint extends Thread {
    private Person person;
    private String value;
    private final String myUrl = "http://194.87.111.127/Php/selectPersonByPrint.php";
    private String parammetrs = "personPrint=";
